...
const faq = [
  ...
  },
  {
    ...
    a: "Сейчас приложение бесплатно для всех. Pro-подписка для гида — 2 000 ₽/мес или 18 000 ₽/год (со скидкой) — будет введена после первых 10 платящих клиентов. Для первых 10 — пожизненная цена основателя 9 000 ₽/год.",
  },
  {
      ...
      <section className={styles.cta}>
        <div className={styles.container}>
          ...
          <p className={styles.ctaDesc}>
            ...
            и отзыв. После — пожизненная подписка по цене основателя 9 000 ₽/год
            (вместо 2 000 ₽/мес или 18 000 ₽/год по обычному тарифу).
          </p>
          <div className={styles.actions}>
            <a href={CONTACT_TG} target="_blank" rel="noopener" className={styles.downloadBtn}>
              Написать в Telegram
