...
const GUIDE_APK_URL = process.env.NEXT_PUBLIC_GUIDE_APK_URL ?? process.env.NEXT_PUBLIC_APK_URL ?? "https://github.com/vraiuk/wifi-tour-guide-landing/releases/download/v1.4.0/tourfi-guide.apk";
const TOURIST_APK_URL = process.env.NEXT_PUBLIC_TOURIST_APK_URL ?? "https://github.com/vraiuk/wifi-tour-guide-landing/releases/download/v1.4.0/tourfi-listener.apk";
const APP_VERSION = process.env.NEXT_PUBLIC_APP_VERSION ?? "1.4.0";
